...
export function WorkCard({ work }: { work: Work }) {
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-5 rounded-3xl border-t-[1px] border-l-[1px] shadow-[2px_6px_0px_1px_#FF085E] md:shadow-[6px_6px_0px_1px_#FF085E] border-gray-700 p-5">
...
export function ProjectCard({ project }: { project: Project }) {
  return (
    <div className="flex flex-col gap-5 rounded-xl border-t-[1px] border-l-[1px] shadow-[2px_6px_0px_1px_#ffbe6f] md:shadow-[6px_6px_0px_1px_#ffbe6f] border-gray-700 p-5">
